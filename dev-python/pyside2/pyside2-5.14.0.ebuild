...
# TODO: Submit a Gentoo issue report that the "dev-qt/designer" cmake files for
# 5.14.0 are badly broken. The compilation error reads as follows:
#
#     CMake Error at /usr/lib64/cmake/Qt5Designer/Qt5Designer_QWebEngineViewPlugin.cmake:4 (_populate_Designer_plugin_properties):
#       _populate_Designer_plugin_properties Macro invoked with incorrect arguments
#       for macro named: _populate_Designer_plugin_properties
#     Call Stack (most recent call first):
#       /usr/lib64/cmake/Qt5Designer/Qt5DesignerConfig.cmake:213 (include)
#       CMakeLists.txt:244 (find_package)
#
# The issue appears to be that the _populate_Designer_plugin_properties() macro
# defined by the "/usr/lib64/cmake/Qt5Designer/Qt5DesignerConfig.cmake" file
# requires a trailing "IsDebugAndRelease" argument, which the
# "/usr/lib64/cmake/Qt5Designer/Qt5Designer_QWebEngineViewPlugin.cmake" file
# calling that macro fails to pass.
#
# Until resolved, we have little choice but to disable Qt5Designer support.
