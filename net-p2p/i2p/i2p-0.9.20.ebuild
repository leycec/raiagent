...
EANT_GENTOO_CLASSPATH="bcprov,jakarta-jstl,java-service-wrapper,jrobin,slf4j-api"
...
src_install() {
	#FIXME: This isn't really ideal. It's almost certainly going to fail for a
	#subsequent version. We probably want to convert this static patch to
	#dynamic "sed" statements, as below.
	#FIXME: O.K.; kill the non-working patch, please.
...
wrapper.java\.library\.path.3='${EROOT}'usr/lib/java-service-wrapper' \
	...
	#these (e.g., "commons-el", "commons-logging", "javax.servlet"). The
