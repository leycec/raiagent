...
#FIXME: It's quite likely ToME4 requires additional USE flags on "libsdl".
...
pkg_setup() {
	ewarn
	ewarn 'ToME4 beta releases (typically) break backwards compatibility with'
	ewarn 'existing save files. Upgrading ToME4 may prevent you from accessing'
	ewarn 'existing characters! Consider either killing off such characters before'
	ewarn 'upgrading or locally masking this upgrade. We apologize for this fatal'
	ewarn 'inconvenience and now return to your regularly scheduled butchery.'
	ewarn
}
