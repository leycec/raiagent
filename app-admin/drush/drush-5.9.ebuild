...
# While overlay "mva" also provides a Drush 5.9 ebuild, such ebuild appears to
# be based on a significantly older ebuild than the official Drush 5.8 ebuild.
# By contrast, this ebuild is based on the official Drush 5.8 ebuild.
EAPI="4"
